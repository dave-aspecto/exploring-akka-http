...
lazy val distProject = project
  ...
  .settings(
    javaAgents += JavaAgent("OpenTelemetry" % "javaagent" % javaAgentVersion % "runtime")
  )

resolvers += "Artifactory" at "https://aspecto.jfrog.io/artifactory/aspecto-public-maven"
run / javaOptions := List(
  "-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=*:5005",
  s"-javaagent:/Users/dave.e/.m2/repository/OpenTelemetry/javaagent/${javaAgentVersion}/javaagent-${javaAgentVersion}.jar"
)
